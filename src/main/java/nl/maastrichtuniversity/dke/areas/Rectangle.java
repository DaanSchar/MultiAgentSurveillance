...
public class Rectangle extends Area {
    ...
    public Rectangle(double x1, double y1, double x2, double y2, AreaType type){
        super(new Vector(x1, y1), x2- x1, y2- y1, type);
    }

    public Rectangle(double x1, double y1, double x2, double y2){
        super(new Vector(x1, y1), x2- x1, y2- y1, AreaType.SHAPE);
    }
